#!/usr/bin/env python3
"""
Fourth pass conversion - catch case variations and edge cases
"""
...
# Additional replacements for fourth pass - case variations
REPLACEMENTS = {
    # Case variations of section labels
    r'\*\s+Deko:': '*   Garnish:',
    r'\*\s+ice:': '*   Ice:',
    r'\*\s+glas:': '*   Glass:',
    r'\*\s+eis:': '*   Ice:',
...
def main():
    print("=" * 80)
    print("GERMAN TO ENGLISH CONVERSION - FOURTH PASS (CASE VARIATIONS)")
    print("=" * 80)
    print()
    ...
    print()
    print("=" * 80)
    print("FOURTH PASS COMPLETE - SUMMARY")
    print("=" * 80)
